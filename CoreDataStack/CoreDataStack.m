...
static CoreDataStack *onlyInstance;
...
+(CoreDataStack*)sharedInstance
{
    ...
    dispatch_once(&onceToken, ^{
        onlyInstance = [[CoreDataStack alloc] init];
    });
    return onlyInstance;
}
...
- (NSManagedObjectContext *)createPrivateObjectContext
{
    ...
    [context setParentContext:_backgroundSaveObjectContext];
...
-(void)setupDataBaseWithManagedObjectModelName:(NSString*)momName databaseName:(NSString*)databaseName canDeleteOnFail:(BOOL)deletable
{
    ...
    if ([self persistentStoreCoordinator] != nil) {
        ...
        [self backgroundSaveObjectContext];
